"""
NKIBench: matmul_add_rmsnorm (SDK 2.28 namespace)
Original: NKIBench/kernels/matmul_add_rmsnorm_M4096_N2048_K2048_0.py
Pattern: matmul → residual add → RMSNorm (fused, reverse order of add_rmsnorm_matmul)
Key learning: matmul result stays in SBUF, then norm applied without HBM round-trip
"""
import nki
